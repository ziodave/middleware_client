...
from middleware_client.api_client import ApiClient, RequestSerialized
from middleware_client.api_response import ApiResponse
from middleware_client.rest import RESTResponseType
...
class DatasetApi:
    ...
    @validate_call
    async def create_or_update_entities1(
        self,
        ...
        _param = self._create_or_update_entities1_serialize(
    ...
    @validate_call
    async def create_or_update_entities1_with_http_info(
        self,
        batch_request: List[BatchRequest],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_or_update_entities1_without_preload_content(
        self,
        batch_request: List[BatchRequest],
        _request_timeout: Union[
            None,
    ...
    def _create_or_update_entities1_serialize(
        self,
        batch_request,
        _request_auth,
        _content_type,
    ...
    async def delete_all_entities(
        ...
        _param = self._delete_all_entities_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def delete_all_entities_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def delete_all_entities_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _delete_all_entities_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    async def delete_entity(
        self,
        uri: Annotated[StrictStr, Field(description="The URI of the entity to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param uri: The URI of the entity to delete. (required)
        :type uri: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    async def delete_entity_with_http_info(
        self,
        uri: Annotated[StrictStr, Field(description="The URI of the entity to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def delete_entity_without_preload_content(
        self,
        uri: Annotated[StrictStr, Field(description="The URI of the entity to delete.")],
        _request_timeout: Union[
            None,
